...
import { DollarSign, BarChart3, CreditCard, Shield } from "lucide-react";
import Image from "next/image";

/**
 * Credit Control Section Component
 * Clean minimal layout with essential content only
 */
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-40 h-40 sm:w-80 sm:h-80 bg-purple-500/8 rounded-full blur-3xl animate-pulse"></div>
      ...
      >
        <DollarSign className="bg-icon absolute top-16 sm:top-20 left-12 sm:left-20 w-4 h-4 sm:w-6 sm:h-6 text-indigo-400/15" />
        <BarChart3 className="bg-icon absolute top-20 sm:top-32 right-16 sm:right-24 w-5 h-5 sm:w-8 sm:h-8 text-purple-400/15" />
        <Shield className="bg-icon absolute bottom-20 sm:bottom-28 left-8 sm:left-16 w-4 h-4 sm:w-7 sm:h-7 text-indigo-400/15" />
        <CreditCard className="bg-icon absolute bottom-12 sm:bottom-20 right-12 sm:right-20 w-4 h-4 sm:w-6 sm:h-6 text-purple-400/15" />
        <DollarSign className="bg-icon absolute top-1/2 left-4 sm:left-8 w-3 h-3 sm:w-5 sm:h-5 text-indigo-400/10" />
        <BarChart3 className="bg-icon absolute top-1/2 right-4 sm:right-8 w-3 h-3 sm:w-5 sm:h-5 text-purple-400/10" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div ref={imageContainerRef} className="relative order-2 lg:order-1">
            ...
            <div className="hidden sm:block absolute -bottom-4 -right-4 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-2xl blur-xl"></div>
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8 order-1 lg:order-2">
            ...
            >
              <span className="word block">Master Your</span>
              <span className="word bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent block">
                Credit Flow
              </span>
            </h2>
            ...
            <div ref={descriptionRef} className="space-y-3 sm:space-y-4">
              <p className="text-sm sm:text-base lg:text-lg text-gray-300 leading-relaxed max-w-lg">
                Transform credit management with intelligent automation,
                comprehensive risk assessment, and streamlined collection
                processes.
              </p>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-4 text-xs sm:text-sm text-gray-400">
                ...
                <span className="flex items-center">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-pink-400 rounded-full mr-1 sm:mr-2"></div>
                  Automated Workflows
                </span>
              </div>
            </div>
            ...
            >
              <button className="px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold rounded-lg hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:scale-105 text-sm sm:text-base">
                Explore Tools
              </button>
